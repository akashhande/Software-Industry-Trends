...
filterdatatask2 = FILTER Sur_2017 BY (DeveloperType matches '.*Web developer.*');
groupdatatask2 = GROUP filterdatatask2 BY (HaveWorkedLanguage);
resulttask2 = FOREACH groupdatatask2 GENERATE group,COUNT(filterdatatask2.HaveWorkedLanguage) desc;
resultfilter = order resulttask2 by counting desc;
result = limit resultfilter 10;
STORE result into '/akashca3/ca3out12' USING PigStorage(',');	
