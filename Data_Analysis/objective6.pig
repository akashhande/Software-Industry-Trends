...
filterdatatask2 = FILTER Sur_2018 BY (DevType matches '.*Full-stack developer*.');
groupdatatask2 = group filterdatatask2 BY JobSatisfaction;
resulttask2 = FOREACH groupdatatask2 GENERATE group,COUNT(filterdatatask2.JobSatisfaction) as counting;
resultfilter = order resulttask2 by counting desc;

STORE resultfilter into '/akashca3/ca3out20' USING PigStorage(',');	
